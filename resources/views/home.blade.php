						...
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								...
								<div class="h5 font-weight-bold mb-0 text-gray-800">
									{{ \App\Krs::where('student_id', auth()->user()->student->id)->count() }}</div>
							</div>
							<div class="col-auto">
								<i class="fas fa-calendar fa-2x text-gray-300"></i>
							</div>
					...
					<div class="card-body">
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								...
								<div class="h5 font-weight-bold mb-0 text-gray-800">
									{{ \App\Khs::where('student_id', auth()->user()->student->id)->count() }}</div>
							</div>
							<div class="col-auto">
								<i class="fas fa-calendar fa-2x text-gray-300"></i>
							</div>
